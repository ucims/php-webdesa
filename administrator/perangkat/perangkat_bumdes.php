...
<a href="admin.php?n=perangkat_bumdes&page=1" class="button" id="butonActive">BUMDES</a>
<hr>
<?php
//tampilkan tahun
include '../koneksi.php';
...
<hr>Halaman <br>
<?php
$query= mysql_query("select * from perangkat where id_jenis='6' ");
$row = mysql_num_rows($query);
$a=$row/10;
$a=ceil($a);
for($b=1; $b<=$a; $b++){
	?>
		<a href="admin.php?n=perangkat_bumdes&page=<?php echo $b; ?>" id="button2" ><?php echo $b; ?></a>
	<?php
}
?>
<hr>
