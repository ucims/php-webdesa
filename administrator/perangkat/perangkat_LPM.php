...
<a href="admin.php?n=perangkat_LPM&page=1" class="button" id="butonActive">LPM</a>
...
<table border="1" id="theTable">
  ...
  <tr>
    ...
    $data = mysql_query("select * from perangkat where id_jenis = '3'; ");
...
<hr>Halaman <br>
<?php
$query= mysql_query("select * from perangkat where id_jenis='3' ");
$row = mysql_num_rows($query);
$a=$row/10;
$a=ceil($a);
for($b=1; $b<=$a; $b++){
	?>
		<a href="admin.php?n=perangkat_LPMa&page=<?php echo $b; ?>" id="button2" ><?php echo $b; ?></a>
	<?php
}
?>
<hr>
