<?php echo'Halaman profil'; ?>
<hr>
<a href="admin.php?n=profil" class="button" id="butonActive">Profil</a>
<a href="admin.php?n=sejarah" class="button">Sejarah</a>
...
<?php
include'../koneksi.php';
$query = "SELECT * FROM data_profil where jenis = 'profil'";
