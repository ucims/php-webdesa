  ...
  $data = mysql_query("select * from struktur_organisasi where id_jenis = '2' and periode='$periode'  ");
  ...
  <?php
  $data = mysql_query("select * from perangkat where id_jenis = '2' and periode='$periode' ");
